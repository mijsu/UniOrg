...
import { GraduationCap, Users, Calendar, DollarSign, Search, Clock, ArrowRight, AlertCircle, CheckCircle, ChevronRight } from 'lucide-react'
  ...
  const loadFeeItems = async (orgIds: string[]) => {
    ...
    try {
      ...
      for (const orgId of orgIds) {
        // Fetch membership status, org details, and activities in parallel
        const [membershipRes, orgRes, activitiesRes] = await Promise.all([
